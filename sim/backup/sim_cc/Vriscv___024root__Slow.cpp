...
void Vriscv___024root___initial__TOP__3(Vriscv___024root* vlSelf) {
    ...
    if (VL_UNLIKELY((0U != VL_TESTPLUSARGS_I("trace")))) {
        __Vtemp11[0U] = 0x2e6c6f67U;
        __Vtemp11[1U] = 0x72616365U;
        __Vtemp11[2U] = 0x74U;
        vlSelf->testbench__DOT__fp = VL_FOPEN_NN(VL_CVT_PACK_STR_NW(3, __Vtemp11)
                                                 , 
                                                 std::string("w"));
    }
    ...
    if (VL_LIKELY((0U != vlSelf->testbench__DOT__imem__DOT__file))) {
        ...
        while (VL_GTS_III(1,32,32, 0x10000U, vlSelf->testbench__DOT__imem__DOT__i)) {
            ...
            if ((0U != vlSelf->testbench__DOT__imem__DOT__r)) {
                vlSelf->testbench__DOT__imem__DOT__ram[(0xffffU 
                                                        & vlSelf->testbench__DOT__imem__DOT__i)] 
                    = ((0xffffff00U & vlSelf->testbench__DOT__imem__DOT__ram
                        [(0xffffU & vlSelf->testbench__DOT__imem__DOT__i)]) 
                       | (vlSelf->testbench__DOT__imem__DOT__data 
                          >> 0x18U));
                vlSelf->testbench__DOT__imem__DOT__ram[(0xffffU 
                                                        & vlSelf->testbench__DOT__imem__DOT__i)] 
        ...
        VL_FINISH_MT("../rtl/../testbench/memmodel.v", 127, "");
    }
    if (VL_UNLIKELY((0U != VL_TESTPLUSARGS_I("help")))) {
        VL_WRITEF("Usage: sim [+help] [+no-meminit] [+dump] [+trace] [prog.elf]\n\n    +help         usage help\n    +no-meminit   memory uninitialized\n    +dump         dump vcd file\n    +trace        generate trace log\n\n");
        VL_FINISH_MT("../rtl/../testbench/testbench.v", 129, "");
    }
    ...
    if (VL_LIKELY((0U != vlSelf->testbench__DOT__dmem__DOT__file))) {
        ...
        while (VL_GTS_III(1,32,32, 0x10000U, vlSelf->testbench__DOT__dmem__DOT__i)) {
            ...
            if ((0U != vlSelf->testbench__DOT__dmem__DOT__r)) {
                vlSelf->testbench__DOT__dmem__DOT__ram[(0xffffU 
                                                        & vlSelf->testbench__DOT__dmem__DOT__i)] 
                    = ((0xffffff00U & vlSelf->testbench__DOT__dmem__DOT__ram
                        [(0xffffU & vlSelf->testbench__DOT__dmem__DOT__i)]) 
                       | (vlSelf->testbench__DOT__dmem__DOT__data 
                          >> 0x18U));
                vlSelf->testbench__DOT__dmem__DOT__ram[(0xffffU 
                                                        & vlSelf->testbench__DOT__dmem__DOT__i)] 
...
void Vriscv___024root___settle__TOP__4(Vriscv___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vriscv__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vriscv___024root___ctor_var_reset(Vriscv___024root* vlSelf) {
    ...
    vlSelf->testbench__DOT__dmem_rdata0 = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__dmem_rdata1 = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__wready = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__rready = VL_RAND_RESET_I(1);
    vlSelf->testbench__DOT__result = VL_RAND_RESET_I(32);
    ...
    vlSelf->testbench__DOT__top__DOT__riscv__DOT__wb_trap_nop = VL_RAND_RESET_I(1);
    ...
    vlSelf->testbench__DOT__top__DOT__riscv__DOT__csr_mstatush = VL_RAND_RESET_I(32);
    ...
    vlSelf->testbench__DOT__top__DOT__riscv__DOT____Vlvbound1 = VL_RAND_RESET_I(32);
    vlSelf->testbench__DOT__top__DOT__riscv__DOT____Vlvbound3 = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vdly__testbench__DOT__top__DOT__riscv__DOT__csr_mtvec = VL_RAND_RESET_I(32);
